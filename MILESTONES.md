...
| 1-5 | PDF 파서 구현 (unpdf/pdf2md → MD) | M | ⬜ |
| 1-6 | CLI 명령어 완성 (commander.js 기반) | M | ⬜ |
...
**완료 기준**:
- [ ] 3개 포맷 각각 실제 파일로 변환 성공
- [ ] CLI로 `docs-to-md <파일>` 실행 가능
- [ ] 각 포맷별 최소 1개 테스트 통과
...
**완료 기준**:
- [ ] 이미지 포함 문서 변환 시 이미지 파일 추출
- [ ] MD 내 `![alt](./images/img_001.png)` 참조 정상 동작
